# CantusSVS
Singing voice synthesis tool to automatically create audio playback for the Latin chants in Cantus. Trained using DiffSinger, which is outlined in [this](https://arxiv.org/abs/2105.02446) paper:
